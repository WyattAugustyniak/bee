    ...
    function preload() {
      ...
      sprite_sheet = loadSpriteSheet('WyattAugustyniak/bee/bee1.png', 32, 32, 8);
      ...
      sprite_sheet = loadSpriteSheet('WyattAugustyniak/bee/poke.png', 32, 37, 7);
      eat_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('WyattAugustyniak/bee/bee1.png', 32, 32, 10);
      hungry_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('WyattAugustyniak/bee/die.png', 32, 35, 12);
      barf_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('WyattAugustyniak/bee/barf.png', 32, 36, 12);
      die_animation = loadAnimation(sprite_sheet);

      //load static images
      bg_image = loadImage("WyattAugustyniak/bee/bg1.png");
      feed_icon = loadImage("WyattAugustyniak/bee/feed_button.png");
      feed_icon_roll = loadImage("WyattAugustyniak/bee/feed_button_roll.png");

      //load sound
      eat_sound = loadSound("WyattAugustyniak/bee/barf.wav");
      barf_sound = loadSound("WyattAugustyniak/bee/die.wav");
      hunger_sound = loadSound("WyattAugustyniak/bee/chirp.wav");
      die_sound = loadSound("WyattAugustyniak/bee/die.wav");
